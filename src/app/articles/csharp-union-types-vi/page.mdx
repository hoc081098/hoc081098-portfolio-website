...
export const article = {
  author: 'hoc081098',
  date: '2026-04-05',
  title: '💠 Union types trong C# (bản Tiếng Việt)',
  description:
...
export const metadata = {
  ...
  openGraph: {
    images: [
      `/api/og?type=article&title=${encodeURIComponent('Union Types trong C# — Discriminated Unions với OneOf')}&description=${encodeURIComponent('Cách mô hình hóa union types và discriminated unions trong C# bằng thư viện OneOf, với ví dụ thực tế cho error handling và domain modeling.')}`,
    ],
  },
}
...
[![Hits](https://hits.sh/portfolio.hoc081098.dev/articles/csharp-union-types-vi.svg)](https://hits.sh/portfolio.hoc081098.dev/articles/csharp-union-types-vi/)
