...
import rxRaceImage from './rx-race.png'

export const article = {
  author: 'hoc081098',
  createdAt: '2026-08-02',
  lastUpdatedAt: '2026-08-02T19:47:51Z',
  title: 'Implementing a race/amb operator for Kotlin Coroutines Flow.',
  description:
    'A practical implementation of race/amb for Kotlin Coroutines Flow using channels and select, with first-event-wins semantics.',
    ...
    images: [
      {
        ...
        alt: 'Three concurrent Kotlin Flows race, with the first event selecting the winner while the others are canceled',
      },
    ],
  },
}
...
<Image
  src={rxRaceImage}
  alt="Marble diagram of the RxJS race operator mirroring the first observable to emit"
...
> [RxJS race documentation](https://rxjs.dev/api/index/function/race)
>
> Returns an observable that mirrors the first source observable to emit an item.
>
> [ReactiveX Amb documentation](https://reactivex.io/documentation/operators/amb.html)
>
