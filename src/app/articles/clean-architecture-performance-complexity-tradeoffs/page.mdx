...
import articleSummaryImage from './summary.png'

export const article = {
  author: 'hoc081098',
  createdAt: '2026-08-01',
  lastUpdatedAt: '2026-08-01T16:19:08Z',
  title:
...
<Image
  src={articleSummaryImage}
  alt="Infographic tổng hợp các layer và trade-off của Clean Architecture về performance, complexity, database usage và CQRS tùy chọn"
  sizes="(min-width: 768px) 42rem, calc(100vw - 3rem)"
  className="mx-auto h-auto w-full max-w-2xl"
/>
