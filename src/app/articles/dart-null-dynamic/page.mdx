...
import dartNullDynamicImage from './dart-null-dynamic.png'
import articleOgImage from './open-graph-1200x630.png'

export const article = {
  author: 'hoc081098',
  createdAt: '2026-09-19',
  lastUpdatedAt: '2026-09-19T13:15:49Z',
  title: 'Null trong Dart: từ dynamic invocation đến null safety',
  description:
    'Giải thích Null trong Dart: bottom type, dynamic invocation, operator ==, nullable types và vai trò của Never.',
  estimatedReadingTime: 9,
  language: 'vi',
  tags: ['dart', 'null-safety', 'type-system', 'dynamic-invocation'],
}
    ...
    images: [
      {
        ...
        alt: 'Legacy Dart lets null flow through a porous type hierarchy, while null-safe Dart routes it into an explicit nullable branch above Never',
      },
    ],
  },
}
...
<Image
  src={dartNullDynamicImage}
  alt="Legacy Dart lỗi ở runtime khi truy cập null, còn null-safe Dart phát hiện lỗi tại compile time"
  sizes="(min-width: 768px) 36rem, calc(100vw - 3rem)"
