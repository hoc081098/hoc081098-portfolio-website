...
export const article = {
  ...
  language: 'vi',
  tags: ['kotlin', 'grouping', 'groupingBy', 'groupBy', 'reduce', 'lazy-evaluation', 'functional-programming', 'hoc081098', 'rx_mobile_team',
      'kotlindev', 'androiddev', 'functional-programming', 'algorithms', 'android'],
}
