...
export const article = {
  author: 'hoc081098',
  date: '2023-05-28',
  title: 'Grouping trong Kotlin (Grouping in Kotlin)',
  description:
...
export const metadata = {
  ...
  openGraph: {
    images: [
      `/api/og?type=article&title=${encodeURIComponent('Grouping trong Kotlin (Grouping in Kotlin)')}&description=${encodeURIComponent('So sánh groupBy, groupingBy và reduce trong Kotlin — phân tích time complexity, space complexity, và cơ chế lazy evaluation của Grouping.')}`,
    ],
  },
}
...
[![Hits](https://hits.sh/portfolio.hoc081098.dev/articles/grouping-in-kotlin.svg)](https://hits.sh/portfolio.hoc081098.dev/articles/grouping-in-kotlin/)
